...
DECLARE @TipoPredio char (10);
DECLARE @Estrato char (5) = '';
DECLARE @AvaluoDesde numeric (38)= 0;
DECLARE @AvaluoHasta numeric (38)= 99999999;
...
Where 
	cnt.ImpCod = @ImpCod 
	and (tip.TprCod	= @TipoPredio or @TipoPredio is null or @TipoPredio = '') 
	and (est.EstCod	= @Estrato or @Estrato is null or @Estrato = '' )
	and (avl.PrdVigAvl BETWEEN @AvaluoDesde and @AvaluoHasta)
	and (dst.DstCod = @Destino or @Destino is null or @Destino = '')
) AS ee	
ORDER BY
	[RANK]
